...
chips_nona |> select(3, 5:9)

# FIX 
#chips_nona$Type |> factor(chips_nona$Type)
...
no_train <- anti_join(remove_train, train)
...
print(glue::glue("Best k: ", best_k, ", Rate: ", best_rate_rounded))
```
